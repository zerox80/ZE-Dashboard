      ...
      {isOpen && (
        <>
          ...
          >
            <div
              className={[
                "pointer-events-auto w-full max-w-lg overflow-hidden rounded-[28px]",
                "border border-white/[0.1] bg-[#0c0f0d]",
                "shadow-[0_32px_100px_rgba(0,0,0,.65)]",
              ].join(" ")}
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-5 p-6">
                ...
                <label className="block">
                  <span className="eyebrow mb-2 block">Beschreibung</span>
                  <textarea
                ...
                <div>
                  <span className="eyebrow mb-3 block">Akzentfarbe</span>
                  <div className="flex flex-wrap gap-2">
                    {PRESET_COLORS.map((preset) => (
                      <button
                        ...
                        className={[
                          "h-9 w-9 rounded-xl transition-transform hover:scale-105",
                          color === preset
                            ? "ring-2 ring-white ring-offset-2 ring-offset-[#0c0f0d]"
                            : "",
                        ].join(" ")}
                    ...
                    <input
                      ...
                      className={[
                        "h-9 w-9 cursor-pointer rounded-xl border border-dashed border-white/20",
