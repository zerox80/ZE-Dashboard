          ...
          {isExportMenuOpen && (
            <div
              className={[
                ...
                "shadow-xl z-50 overflow-hidden animate-in fade-in zoom-in-95",
                "duration-100",
              ].join(" ")}
            >
              <button
                ...
                className={[
                  "w-full text-left px-4 py-3 text-sm text-gray-300 hover:bg-gray-700",
                  "hover:text-white transition-colors border-b border-gray-700/50",
                ].join(" ")}
              >
                Als Excel (.xlsx)
              </button>
        ...
        <div className="bg-gray-800/50 border border-gray-700 rounded-xl p-4 space-y-4 animate-in slide-in-from-top-2">
          ...
          <div className="flex flex-wrap gap-4 items-end">
            ...
            <button
              ...
              className={[
                "flex items-center gap-2 px-4 py-2 bg-gray-700 hover:bg-gray-600",
